...
class Trainer:
    ...
    def validate_one_epoch(
        ...
        self.metric_tracker.val_loss.reset()

        self.metric_tracker.recall1.reset()

        self.metric_tracker.recall5.reset()

        self.metric_tracker.positive_distance.reset()

        self.metric_tracker.negative_distance.reset()
